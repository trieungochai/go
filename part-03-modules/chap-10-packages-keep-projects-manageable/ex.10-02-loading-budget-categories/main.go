// Write a program that will load budget categories into a global map, before the main() function runs.
// The main() function should then print out the data on the map.
package main
